...
create table with_one_mouth(id int PRIMARY KEY NOT NULL,words1 varchar(20), words2 varchar(20))

drop table if exists communication cascade
create table communication(id int PRIMARY KEY NOT NULL,category varchar(20), question varchar(100))